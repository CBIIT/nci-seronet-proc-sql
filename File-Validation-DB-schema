...
CREATE TABLE IF NOT EXISTS `seronetdb-prevalidated`.`Prior_Test_Result` (
  ...
  `Duration_of_CMV_infection_unit` varchar(10),
  ...
  `Duration_of_HepB_infection_unit` varchar(10),
  ...
  `Duration_of_EBV_infection_unit` varchar(10),
  ...
  `Duration_of_HIV_infection_unit` varchar(10),
  `On_HAART_Therapy` varchar(255),
  `Duration_of_HAART_Therapy` int,
  `Duration_of_HAART_Therapy_unit` varchar(10),
  ...
  `Duration_of_Seasonal_Coronavirus_infection_unit` varchar(10),
  PRIMARY KEY (`Research_Participant_ID`),
